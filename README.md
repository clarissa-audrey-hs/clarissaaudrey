...
| [`frontend-testing.md`](./frontend-testing.md) | **Frontend** companion doc — channel-integrations FE testing strategy, MSW handler fidelity, jest/Storybook/Playwright surfaces. |
| [`services-inventory.md`](./services-inventory.md) | **Inventory** — what other Hootsuite services have for integration and contract testing today. Sampled SCUM, SNP, dashboard. Patterns to borrow, patterns to avoid, gaps our plan addresses. |
